...
expect(index.includes('class="route-place-search-icon"') && index.includes('<span data-carbon-icon="search"></span>'), 'Route search does not request the official Carbon Search icon');
...
expect(carHeaderCss.includes('.capacity-edit-content > .carbon-icon') && carHeaderCss.includes('width: 20px;'), 'Capacity edit icon does not use the Carbon 20px size');
