...
expect(copyCss.includes('--cds-button-tertiary: var(--app-accent-border)'), 'Settlement copy action lacks a visible Carbon tertiary boundary token');
expect(!copyCss.includes('box-shadow: inset 0 0 0 1px var(--app-accent-border)'), 'Settlement copy action duplicates Carbon tertiary styling with a host shadow');
